...
const Home = () => {
  ...
  return (
    <>
      <div
        className="container-fluid pl-4 pr-4  w-100 h-90 d-none d-md-block "
        id="home-container"
        style={{ marginTop: "35px", overflowY: "auto", marginLeft: "65px" }}
      >
        <div
      ...
      <div
        className="container-fluid pl-4 pr-4  w-100 h-90 d-md-none"
        id="home-container"
